                        ...
                        fluidRow(
                          ...
                          column(8,
                                 ...
                                 p(paste("On this website we present the interactive plots, created during our research project on ",
                                         ...
                                         "The cell lines were two primary cell lines, the endothelial cell of umbilical vein (vein present during fetal development, connecting placenta and fetus)",
                                         ...
                                         "we used in the Data Comparison tab a smaller set of 5 histone modifications (H3K27ac, H3K36me3, H3K9me3, H3K4me3, H3K27me3), but three additional data sets,",
                                 ...
                                 p(paste("Different histone modifications play a differnent role for the prediction. In this tab we compare the importance ",
                                         "of the different histone modifications, by measuring the performance when predicting only with one or two histone modifications instead of all.")),
                                 ...
                                 p(paste("We compared six different datasets with each other, two immortalized cell lines, two tissues and two primary cell lines. ",
                                         "Additionally, we created a big merged data set, containg the cell lines K562, keratinocytes and gastrocnemius medialis,",
                                         "to see if more general features can be learned with this data set.",
                                         "The first plot shows a cross-valdiation for each of the seven data sets.",
                                          "The second plot shows the performance, when training the models with one data set and predicting the other data sets.")),
                                 h2("Deep Learning"),
                                 p(paste("We implemented also a convolutional neuronal network to see if deep learning could further improve our performance. This tab is to show our result that we got ",
                                         " when trying to fit some of its parameter. We tested different numbers of convolution layers for our convolutional neuronal network",
