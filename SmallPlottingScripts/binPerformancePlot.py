...
filename="/home/sch/schmidka/Dokumente/GeneExpressionPrediction/neap/InteractivePlots/PlotInput/evalBinsReg.txt"
dataset="K562"
#score="AUC"
score="R2"
...
#filenameDL="/home/sch/schmidka/Dokumente/GeneExpressionPrediction/neap/InteractivePlots/PlotInput/deepLearningBins.txt"
#
...
plt.plot(range(0,160),aucs['RF'],label="RF")
plt.plot(range(0,160), aucs['SVM'],label="SVM")
#plt.plot(range(0,160), aucs['DL'],label="DL")
plt.plot(range(0,160), aucs['LR'],label="LR")
plt.xlabel("Bin")
...
#plt.title('Performance of '+dataset+' for each bin with different classification methods', fontsize=12)
plt.title('Performance of '+dataset+' for each bin with different regression methods', fontsize=12)
